...
def nms(boxes, scores):
    ...
    indexes = cv2.dnn.NMSBoxes(rects, scores.tolist(), CONF_THRESHOLD, NMS_THRESHOLD)
...
while True:
    ...
    boxes, scores, labels = decode(output[0], frame.shape)
    ...
    cv2.imshow("NanoDet Plus ONNX", frame)
